...
import { Navbar, Container, Nav, Card, Button, Col ,Row , Form } from 'react-bootstrap'; // Importing necessary components from react-bootstrap
...
function App() {
  return (
    <React.Fragment> {/* Using a shorthand for <React.Fragment> */}
      <div className="App">
        {/* Navbar */}
        <Navbar className="Navv" bg="primary" variant="dark"> {/* Creating a Bootstrap Navbar */}
          <Container className='contNav'> {/* Container for Navbar content */}
            <Navbar.Brand href="#home">First Page React </Navbar.Brand> {/* Navbar brand */}
        ...
        {/* Heading */}
        <h1>Welcome</h1> {/* A simple heading on the page */}
        ...
        {/* End of Cards */}
        <Container className='secont'>
        <Card className="aa bg-dark text-white">
    ...
    <MDBFooter bgColor='primary' className='i text-center text-lg-start text-muted' >
